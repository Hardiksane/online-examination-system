<html>
<head>
<title>set success thirdyear</title>
</head>
...
$query = "UPDATE `thirdyear`.`subjects` SET `setPaper` = '1', `cutoff` = '$cutoff' WHERE `subjects`.`name` = '$s' LIMIT 1";
$query1 = "UPDATE `thirdyear`.`subjects` SET `setPaper` = '0' WHERE `subjects`.`name` != '$s'";
