...
<html>
    <head>
        <title>select Paper SecondYear</title>
...
?>
 <?php include 'ppp.php'; ?>
    ...
    <h2 style="color:red">Set Subject Paper For Second Year!!!!</h2>
    <form name="frm" action="set2done.php" method="post" onsubmit="return valid(this);">
        <select name="sub">
