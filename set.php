	...
	if(isset($_SESSION['Sname']))
{
 ...
 <?php include 'ppp.php'; ?>
 <h1 style="color:red">set Question Paper !!!!</h1>
<table>
    <tr bgcolor="#cf0"><th><h3><a href="set4.php">For First Year!!!!</a></h3></th></tr>
       <tr bgcolor="#bf0"><th><h3> <a href="set2.php">For Second Year!!!!</a></h3></th></tr>
        <tr bgcolor="yellow"><th><h3><a href="set3.php">For Third Year!!!!</a></h3></th></tr>
