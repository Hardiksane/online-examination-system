<html>
    <head>
        <title>select Paper thirdyear</title>
...
<html>
    ...
    <body>
    <h2 style="color:red">Set Subject For Third Year!!!!</h2>
    <form name="frm" action="set3done.php" method="post" onsubmit="return valid(this);">
        <select name="sub">
